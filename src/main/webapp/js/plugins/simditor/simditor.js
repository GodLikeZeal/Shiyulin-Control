  ...
  ImageButton.prototype.renderMenu = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input type="file" title="' + _this._t('uploadImage') + '" accept="image/jpg,image/jpeg,image/png">').appendTo($uploadItem);
      };
    })(this);
    createInput();
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input type="file" title="' + _this._t('uploadImage') + '" accept="image/jpg,image/jpeg,image/png">').appendTo($uploadBtn);
      };
    })(this);
    createInput();
